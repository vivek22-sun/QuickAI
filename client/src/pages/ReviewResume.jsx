  ...
  return (
    <div className='w-full min-h-screen bg-[#f7f8fa] flex items-center justify-center'>
      <div className='w-full max-w-6xl flex gap-6 px-4 py-10'>
        ...
        <div className='bg-white border border-gray-100 rounded-xl shadow flex-1 min-h-[300px] p-8 flex flex-col items-center justify-center'>
          <div className='flex items-center gap-2 mb-6'>
